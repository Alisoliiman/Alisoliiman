...
| **Telecommunications** | ![Telecom](https://img.shields.io/badge/Telecom_Engineering-%23113262?style=flat-square&logo=rss&logoColor=white) `5G NR Downlink` `Open RAN (ORAN)` `LDPC Coding` |
...
| **System Administration** | ![SysAdmin](https://img.shields.io/badge/Linux_SysAdmin-%234EAA25?style=flat-square&logo=gnu-bash&logoColor=white) `MCSA` `RHCSA I & II` `GNU Bash Scripting` `CLI Linux` |
